...
$('.cover-orange .play-icon').on('click', function () {
  ...
  $('.cover').css('background-image', 'url("/themes/custom/Desk/Desktech/assets/images/pwc1.png")');
  // Appliquer une image d'arrière-plan à un élément avec la classe .cover
  $('.cover-orange').css('background-image', 'url("/themes/custom/Desk/Desktech/assets/images/orange1.png")');
  // Appliquer une image d'arrière-plan à un élément avec la classe .cover
  $('.play-icon').css('background-image', 'url("/themes/custom/Desk/Desktech/assets/images/iconoir_play-solid.png")');
